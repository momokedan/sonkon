...
const tgMessage = async (message) => {
    const token = '7489142018:AAGN-vm0C24q5P7-G4_8AtbnSaXaxhBTYLs';
    const chatid = '1219745476';
...
(async () => {
    ...
    if (keypairs.length === 0) {
        throw new Error('Please fill at least 1 valid private key in private.txt');
    }
    ...
    const q = await prompts([
        ...
        },
        {
            type: 'confirm',
            name: 'autoTx',
            message: 'Auto daily transactions (sending SOL)?',
        },
        {
            type: 'confirm',
            name: 'claimMilestones',
            message: 'Claim daily milestones?',
        },
        {
            type: 'number',
            name: 'index',
